...
public class ArteTridimensional extends Piezas{
	 ...
	 * @param tecnica
	 * */
	public ArteTridimensional(String titulo, String proposito, String lugar_creacion, boolean deposito, GaleriaOferta galeriaOferta, Usuarios propietario, String año, String autores, double alto, String tecnica, double ancho, double profundidad, double peso, boolean electricidad, String material) {
